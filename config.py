...
# Список из 20+ реальных User-Agent'ов для Windows, Mac, Linux
USER_AGENTS = [
    # Windows
...
# Загрузка прокси из файла, если он существует
...
# Видимость браузера (False = видимый браузер)
HEADLESS = False

# Поддерживаемые платформы (название -> класс парсера)
SUPPORTED_PLATFORMS = {
    'dubicars': 'DubiCarsParser',
    'autoscout24': 'AutoScout24Parser',
    'bidcars': 'BidCarsParser',
    'encar': 'EncarParser',
    'che168': 'Che168Parser',
    'autohome': 'AutoHomeParser',
}
